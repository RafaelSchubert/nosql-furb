...
> db.italians.find({$where: function(){ return this["cat"]!=null && this["age"] < this["cat"]["age"]; }})
...
> db.italians.find({$or: [{cat: {$exists: true}}, {dog: {$exists: true}}]}, {cat: true, dog: true, _id: false})
